...
@Component({
  ...
  template: `
    <div class="challenge-content">
      ...
      <p class="challenge-desc">Select all <strong>{{ targetCategory }}</strong>.</p>
      ...
      <div class="image-grid">
        ...
        >
          <div class="shape-container">
             <div *ngIf="img.type === 'circle'" class="shape circle" [style.background-color]="img.color"></div>
             <div *ngIf="img.type === 'square'" class="shape square" [style.background-color]="img.color"></div>
             <div *ngIf="img.type === 'triangle'" class="shape triangle" [style.border-bottom-color]="img.color"></div>
          </div>
      ...
      <p class="error-msg" *ngIf="hasError">Incorrect selection, please try again.</p>
...
export class ImageChallengeComponent implements OnInit {
  ...
  private shapes: ('circle' | 'square' | 'triangle')[] = ['circle', 'square', 'triangle'];
  ...
  generateGrid() {
    ...
    this.images = Array(9).fill(null).map((_, i) => {

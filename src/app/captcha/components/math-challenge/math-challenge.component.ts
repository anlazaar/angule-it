...
@Component({
  ...
  template: `
    <div class="challenge-content">
      ...
      <div class="input-group">
        ...
        >
        <p class="error-msg" *ngIf="hasError">Incorrect answer, please try again.</p>
      </div>
      
      <button class="btn btn-primary" (click)="verify()" [disabled]="answerControl.invalid">
        Verify
      </button>
    </div>
  `,
  styles: [`
    ...
    .question-mark { color: var(--primary-color); }
    .input-group {
      display: flex;
      flex-direction: column;
      gap: 8px;
